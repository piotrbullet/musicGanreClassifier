...
from tensorflow.keras.layers import Dense, Conv2D, MaxPool2D, Activation, Flatten, Dropout, Softmax
...
def main():
    ...
    for count, s in enumerate(models_set):
        ...
        history = train_model(mdl, x_train, y_train, mdl_no, folder_no, lr=0.0005)
